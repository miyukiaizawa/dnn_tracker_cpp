...
public:
  ...
  DNNTRR_API child_object(child_object* obj);
  DNNTRR_API child_object& operator = (child_object* obj);

  DNNTRR_API region::track_box& parent();
  DNNTRR_API const region::track_box& parent() const;
...
DNNTRR_API std::tstring make_parent_name(const child_object& child, 
